#THIS seed_1.rb FILE HAS BEEN USED IN ORDER TO ENSURE THE CORRECTNESS OF THE update_post_status_job
...
p1 = Post.create({ descrizione: 'Lorem ipsum', titolo: 'Esempio', data: '26/09/2023', ora: '23:20',
