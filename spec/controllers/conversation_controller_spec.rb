  ...
  include Devise::Test::ControllerHelpers
    ...
    describe "GET #show" do
      it "assigns the conversation and messages" do
        ...
        #debug
        puts "Assignments: #{@conversation}, #{@messages}"
        puts "Conversation ID: #{assigns(:conversation)&.id}"
        puts "Messages Count: #{assigns(:messages)&.count}"
        allow(Conversation).to receive(:find).and_call_original
